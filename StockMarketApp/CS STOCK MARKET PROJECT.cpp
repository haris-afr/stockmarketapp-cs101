...
using namespace std; 
 string returnNews (int percentage_increase,int stock_index)               {
	...
	if(percentage_increase >= 120 && percentage_increase <= 150 )  {  return " Investors were impressed by Google's advancements in artificial intelligence.\n The company announced several new AI powered products and services.";
	}
